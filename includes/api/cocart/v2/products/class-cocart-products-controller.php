...
class CoCart_Products_V2_Controller extends CoCart_Products_Controller {
	...
	protected function get_product_data( $product ) {
		...
		$data = array(
			...
			'dates'              => array(
				'created'      => cocart_prepare_date_response( $product->get_date_created( 'view' ), false ),
				'created_gmt'  => cocart_prepare_date_response( $product->get_date_created( 'view' ) ),
				'modified'     => cocart_prepare_date_response( $product->get_date_modified( 'view' ), false ),
				'modified_gmt' => cocart_prepare_date_response( $product->get_date_modified( 'view' ) ),
			),
			...
			'prices'             => array(
				...
				'date_on_sale'  => array(
					'from'     => cocart_prepare_date_response( $product->get_date_on_sale_from( 'view' ), false ),
					'from_gmt' => cocart_prepare_date_response( $product->get_date_on_sale_from( 'view' ) ),
					'to'       => cocart_prepare_date_response( $product->get_date_on_sale_to( 'view' ), false ),
					'to_gmt'   => cocart_prepare_date_response( $product->get_date_on_sale_to( 'view' ) ),
				),
