...
<div class="notice notice-info cocart-notice">
	<div class="cocart-notice-inner">
		...
		<div class="cocart-notice-content">
			<h3>
				<strong><?php echo sprintf( esc_html__( '%s database update required', 'cart-rest-api-for-woocommerce' ), 'CoCart' ); ?></strong>
			</h3>
			<p>
				<?php
				...
				printf( ' ' . esc_html__( 'The database update process runs in the background and may take a little while, so please be patient. Advanced users can alternatively update via %1$sWP CLI%2$s.', 'cart-rest-api-for-woocommerce' ), '<a href="#Upgrading-the-database-using-WP-CLI">', '</a>' );
				?>
			</p>
		</div>
		...
		<div class="cocart-action">
			<a href="<?php echo esc_url( $update_url ); ?>" class="button button-primary cocart-button">
				<?php echo sprintf( esc_html__( 'Update %s Database', 'cart-rest-api-for-woocommerce' ), 'CoCart' ); ?>
			</a>
