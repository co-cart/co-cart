...
class CoCart_Products_V2_Controller extends CoCart_Products_Controller {
	...
	/**
	 * Returns the orderby label if set.
	 *
	 * @access public
	 * @since  3.2.0 Introduced.
	 * @param  array  $args          Query arguments.
	 * @return string $orderby_label Order By Label.
	 */
	public function get_orderby_label( $args ) {
		if ( isset( $args['orderby'] ) ) {
			switch ( $args['orderby'] ) {
				case 'id':
					$orderby = __( 'Product ID', 'cart-rest-api-for-woocommerce' );
					break;
				case 'menu_order':
			...
			$orderby = __( 'Default sorting', 'cart-rest-api-for-woocommerce' );
		}

		return $orderby;
	} // END get_orderby_label()
