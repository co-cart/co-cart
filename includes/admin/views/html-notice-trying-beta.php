...
<div class="notice notice-info cocart-notice">
	<div class="cocart-notice-inner">
		...
		<div class="cocart-send-feedback">
			<?php printf( '<a href="%1$s" class="button button-primary cocart-feedback-button" target="_blank">%2$s</a>', esc_url( 'https://cocart.xyz/contact/' ), esc_html__( 'Give Feedback', 'cart-rest-api-for-woocommerce' ) ); ?>
