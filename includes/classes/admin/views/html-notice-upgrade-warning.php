...
<div class="notice notice-info cocart-notice" role="alert">
	<div class="cocart-notice-inner">
		...
		<div class="cocart-action">
			<?php printf( '<a href="%1$s" class="button button-primary cocart-button" target="_blank" rel="noopener noreferrer" role="button">%2$s</a>', esc_url( 'https://github.com/cocart-headless/cocart-community/blob/development/NEXT_CHANGELOG.md' ), esc_html__( "What's Coming Next?", 'cart-rest-api-for-woocommerce' ) ); ?>
