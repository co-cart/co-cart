...
if ( ! is_plugin_active( 'woocommerce/woocommerce.php' ) && file_exists( WP_PLUGIN_DIR . '/woocommerce/woocommerce.php' ) ) :
	...
	if ( current_user_can( 'activate_plugin', 'woocommerce/woocommerce.php' ) ) :
		...
		echo '<a href="' . esc_url( wp_nonce_url( self_admin_url( 'plugins.php?action=activate&plugin=woocommerce/woocommerce.php&plugin_status=active' ), 'activate-plugin_woocommerce/woocommerce.php' ) ) . '" class="button button-primary" aria-label="' . esc_html__( 'Activate WooCommerce', 'cart-rest-api-for-woocommerce' ) . '>' . esc_html__( 'Activate WooCommerce', 'cart-rest-api-for-woocommerce' ) . '</a>';
