		...
		<div class="cocart-next-step-action">
			<div class="column-container">
				...
				<div class="column">
					...
					<a class="button cocart-button-alt" href="<?php echo esc_url( CoCart_Helpers::build_shortlink( add_query_arg( $campaign_args, esc_url( COCART_COMMUNITY_URL ) ) ) ); ?>" target="_blank" role="button"><?php esc_html_e( 'Join Community', 'cocart-core' ); ?></a>
				</div>
				<?php
